                ...
                <div class="form-group">
                  ...
                  <label for="last_name"><span class="required-red"> *</span> Last Name:</label><input type="text" name="last_name" class="form-control form-control-lg mb-2 @error('last_name') is-invalid @enderror" value="{{ old('last_name') }}" placeholder="Last Name">
                    ...
                    @enderror
                      ...
                      <div class="col">
                        <label for="tel"><span class="required-red"> *</span> Tel#:</label><input type="tel" name="tel" class="form-control form-control-lg mb-2 @error('tel') is-invalid @enderror" value="{{ old('tel') }}" placeholder="01 23 45 67 89">
                        @error('tel')
                          <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                      </div>
